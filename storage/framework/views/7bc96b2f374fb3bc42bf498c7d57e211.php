<?php $__env->startSection('content'); ?>
    ...
    <section class="bg-slate-100 py-24 px-4">
        <div class="max-w-3xl mx-auto">
            ...
            <form action="<?php echo e(route('contact.store')); ?>" method="POST" class="space-y-6 bg-white p-8 md:p-10 rounded-2xl shadow-xl border border-gray-100">
                <?php echo csrf_field(); ?>
                <div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\kp-coba\resources\views/welcome.blade.php ENDPATH**/ ?>